 ...
 */
final class Version20200317220619 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Trajet (id INT AUTO_INCREMENT NOT NULL, ville_depart VARCHAR(255) NOT NULL, ville_arrivee VARCHAR(255) NOT NULL, heure_depart DATETIME NOT NULL, heure_arrivee DATETIME NOT NULL, prix DOUBLE PRECISION NOT NULL, nb_places INT NOT NULL, description VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, date_expiration DATE DEFAULT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
