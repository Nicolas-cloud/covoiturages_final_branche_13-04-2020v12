 ...
 */
final class Version20200330165356 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, passager_id INT DEFAULT NULL, date_reservation DATE NOT NULL, validation TINYINT(1) NOT NULL, annulation TINYINT(1) NOT NULL, INDEX IDX_42C8495571A51189 (passager_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
